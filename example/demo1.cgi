...
Start(
    ...
    list_rows      => 15,
    templates      => '/temp/releases/gedafe/example/templates',
    schema	   => 'public',
    schema_search_path => " 'public' ",     
    pearl_dir      => '/temp/releases/gedafe/example/mypearls',
    widget_dir      => '/temp/releases/gedafe/example/mywidgets',
    oyster_dir      => '/temp/releases/gedafe/example/myoysters',
